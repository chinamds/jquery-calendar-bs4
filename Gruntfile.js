    ...
    copy: {
      main: {
        files: [
          ...
          { expand: true, cwd: 'node_modules/@fortawesome/', src: '**/*', dest: 'public/libs/font-awesome' },
          { expand: true, cwd: 'node_modules/moment/', src: '**/*', dest: 'public/libs/moment' },
          { expand: true, cwd: 'node_modules/jquery-touchswipe/', src: '*', dest: 'public/libs/jquery-touchswipe' },
          { expand: true, cwd: 'node_modules/popper.js/dist/', src: '**/*', dest: 'public/libs/popper.js' },
          // setup unminified
